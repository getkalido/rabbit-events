...
//
//	mockgen -package=test -destination=auto_generated_rabbitGenMock.go github.com/getkalido/rabbit-events RabbitEventHandler,EventConsumer,RabbitExchange,RabbitConfig
//
...
func (m *MockRabbitEventHandler) Consume(path string, typer ...func() any) (rabbitevents.EventConsumer, error) {
	m.ctrl.T.Helper()
	varargs := []any{path}
	for _, a := range typer {
...
func (mr *MockRabbitEventHandlerMockRecorder) Consume(path any, typer ...any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	varargs := append([]any{path}, typer...)
...
func (m *MockRabbitEventHandler) Emit(path string) rabbitevents.EventEmitter {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Emit", path)
	ret0, _ := ret[0].(rabbitevents.EventEmitter)
	return ret0
}

// Emit indicates an expected call of Emit.
func (mr *MockRabbitEventHandlerMockRecorder) Emit(path any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Emit", reflect.TypeOf((*MockRabbitEventHandler)(nil).Emit), path)
}
...
func (m *MockEventConsumer) Subscribe(ids []int64, handler func(*rabbitevents.Event)) rabbitevents.Unsubscribe {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Subscribe", ids, handler)
	ret0, _ := ret[0].(rabbitevents.Unsubscribe)
	return ret0
}

// Subscribe indicates an expected call of Subscribe.
func (mr *MockEventConsumerMockRecorder) Subscribe(ids, handler any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Subscribe", reflect.TypeOf((*MockEventConsumer)(nil).Subscribe), ids, handler)
}

// SubscribeUnfiltered mocks base method.
func (m *MockEventConsumer) SubscribeUnfiltered(handler func(*rabbitevents.Event)) rabbitevents.Unsubscribe {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "SubscribeUnfiltered", handler)
	ret0, _ := ret[0].(rabbitevents.Unsubscribe)
	return ret0
}

// SubscribeUnfiltered indicates an expected call of SubscribeUnfiltered.
func (mr *MockEventConsumerMockRecorder) SubscribeUnfiltered(handler any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "SubscribeUnfiltered", reflect.TypeOf((*MockEventConsumer)(nil).SubscribeUnfiltered), handler)
}
...
func (m *MockRabbitExchange) BulkReceive(exchange rabbitevents.ExchangeSettings, queue rabbitevents.QueueSettings, maxWait time.Duration, batchSize int) (func(rabbitevents.BulkMessageHandleFunc) error, func(), error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "BulkReceive", exchange, queue, maxWait, batchSize)
...
func (mr *MockRabbitExchangeMockRecorder) BulkReceive(exchange, queue, maxWait, batchSize any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "BulkReceive", reflect.TypeOf((*MockRabbitExchange)(nil).BulkReceive), exchange, queue, maxWait, batchSize)
}

// BulkReceiveFrom mocks base method.
func (m *MockRabbitExchange) BulkReceiveFrom(name, exchangeType string, durable, autoDelete bool, key, clientName string, prefetchCount int, maxWait time.Duration, batchSize int) (func(rabbitevents.BulkMessageHandleFunc) error, func(), error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "BulkReceiveFrom", name, exchangeType, durable, autoDelete, key, clientName, prefetchCount, maxWait, batchSize)
	ret0, _ := ret[0].(func(rabbitevents.BulkMessageHandleFunc) error)
	ret1, _ := ret[1].(func())
	ret2, _ := ret[2].(error)
	return ret0, ret1, ret2
...
func (mr *MockRabbitExchangeMockRecorder) BulkReceiveFrom(name, exchangeType, durable, autoDelete, key, clientName, prefetchCount, maxWait, batchSize any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "BulkReceiveFrom", reflect.TypeOf((*MockRabbitExchange)(nil).BulkReceiveFrom), name, exchangeType, durable, autoDelete, key, clientName, prefetchCount, maxWait, batchSize)
}
...
func (m *MockRabbitExchange) Receive(exchange rabbitevents.ExchangeSettings, queue rabbitevents.QueueSettings) (func(rabbitevents.MessageHandleFunc) error, func(), error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Receive", exchange, queue)
...
func (mr *MockRabbitExchangeMockRecorder) Receive(exchange, queue any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Receive", reflect.TypeOf((*MockRabbitExchange)(nil).Receive), exchange, queue)
}

// ReceiveFrom mocks base method.
func (m *MockRabbitExchange) ReceiveFrom(name, exchangeType string, durable, autoDelete bool, key, clientName string) (func(rabbitevents.MessageHandleFunc) error, func(), error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ReceiveFrom", name, exchangeType, durable, autoDelete, key, clientName)
	ret0, _ := ret[0].(func(rabbitevents.MessageHandleFunc) error)
	ret1, _ := ret[1].(func())
	ret2, _ := ret[2].(error)
	return ret0, ret1, ret2
...
func (mr *MockRabbitExchangeMockRecorder) ReceiveFrom(name, exchangeType, durable, autoDelete, key, clientName any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ReceiveFrom", reflect.TypeOf((*MockRabbitExchange)(nil).ReceiveFrom), name, exchangeType, durable, autoDelete, key, clientName)
}

// SendTo mocks base method.
func (m *MockRabbitExchange) SendTo(name, exchangeType string, durable, autoDelete bool, key string) rabbitevents.MessageHandleFunc {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "SendTo", name, exchangeType, durable, autoDelete, key)
	ret0, _ := ret[0].(rabbitevents.MessageHandleFunc)
	return ret0
}

// SendTo indicates an expected call of SendTo.
func (mr *MockRabbitExchangeMockRecorder) SendTo(name, exchangeType, durable, autoDelete, key any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "SendTo", reflect.TypeOf((*MockRabbitExchange)(nil).SendTo), name, exchangeType, durable, autoDelete, key)
}
